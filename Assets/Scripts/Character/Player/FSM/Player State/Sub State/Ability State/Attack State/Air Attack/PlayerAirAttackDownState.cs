...
{
    public class PlayerAirAttackDownState : PlayerAttackState
    {
        public bool AttackEnable => Time.time > startTime + coreManager.MoveCore.PlayerData.airAttackCoolDown;
        
        public PlayerAirAttackDownState(CharacterManager manager, string animBoolName) : base(manager, animBoolName)
        {
        }
